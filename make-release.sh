#!/bin/bash
# Baut Finestra, signiert mit Developer ID (Hardened Runtime),
...
# (iCloud haengt sonst com.apple.FinderInfo an, an dem codesign scheitert).
# Ergebnis: Finestra.zip im Projektordner (fuer GitHub-Release).
set -euo pipefail
cd "$(dirname "$0")"
PROJ="$(pwd)"

SIGN_ID="Developer ID Application: Sebastian Kardos (GW847K38C6)"
NOTARY_PROFILE="ShortKeyOrganiser-Notary"   # gleiches Apple-Konto/Team, fuer alle Apps nutzbar
ZIP="Finestra.zip"
